...
//
//            var request: HttpRequest<Any> = HttpRequest.POST("/genres", GenreSaveDto("DevOps"))
//            var response: HttpResponse<Any> = client.toBlocking().exchange(request)
//            genreIds.add(entityId(response))
//
//            assertEquals(HttpStatus.CREATED, response.status)
//
//            request = HttpRequest.POST("/genres", GenreSaveDto("Microservices"))
...
//
//            request = HttpRequest.PUT("/genres", GenreUpdateDto(id, "Micro-services"))
//            response = client.toBlocking().exchange(request)
//
